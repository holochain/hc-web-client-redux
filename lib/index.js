...
exports.connect = function (paramUrl) { return new Promise(function (fulfill, reject) { return __awaiter(_this, void 0, void 0, function () {
    var url, _a, ws;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, getUrlFromContainer().catch(function () { return reject('Could not auto-detect DNA interface from conductor. \
Ensure the web UI is hosted by a Holochain Conductor or manually specify url as parameter to connect'); })];
            ...
            case 2:
                ...
                ws.on('open', function () {
                    ...
                    var callZome = function (instanceId, zome, func) { return function (params) {
                        var callObject = {
                    ...
                    fulfill({ call: call, callZome: callZome, close: close, ws: ws });
                });
                return [2 /*return*/];
        }
    });
